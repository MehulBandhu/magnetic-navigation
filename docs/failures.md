...
| The first explanation for the estimator's failure on real tiles, a high-frequency noise plateau that a mid-band prior ignores, measured as 0.3 to 0.4 of the power law (a deficit, the opposite) | The error-concentration statistic: 0.6 of the squared error in the worst 5% of pixels, which is seams and artefacts |
